...
try:
    ...
    cursor.execute("""
        ...
        ('Muhammadjon', 'Abdujabborov', 17, 'muhammadjonabdujabborov634@gmail.com'),
        ('Davronbek ', 'Nazarov', 15, 'david@gmail.com'),
        ('Abdulloh', 'Ahmadjonov', 17, 'able_07@gmail.com');
